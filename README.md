...
> **30,000+ Big Data 기반 지능형 축사 CCTV 오염 탐지 및 자율 복구 시뮬레이션 플랫폼**
...
본 프로젝트는 **총 30,000장 이상의 방대한 데이터셋**을 학습하여 실전 환경에서의 압도적인 강건성(Robustness)을 확보했습니다.

### 📊 Dataset Pipeline
| Category | Quantity | Source | Key Focus |
| :--- | :--- | :--- | :--- |
| **Open Dataset** | **20,000+** | AI Hub 공공 데이터 | 대규모 개체(소) 인식 및 환경 적응력 강화 |
| **Custom Robustness** | **10,000+** | 자체 구축 데이터 | **손바닥/인적 간섭 무시(Negative Sampling)** |
...
- **High-Precision Detection**: YOLO11m 모델을 최적화하여 15ms 내외의 초고속 오염 탐지 구현.
...
├── 01_Model/
│   └── best.pt               # 30,000장 학습 완료 통합 마스터 가중치 파일
├── 02_Cattle_Dataset/
...
python3 vision_doctor_system.py
```
...
* **mAP@50**: 85%↑(성능 향상 진행중)
<img width="513" height="258" alt="image" src="https://github.com/user-attachments/assets/7b398620-5d97-40c1-b737-67aef3355ff3" />

* **Inference Speed**: 18ms (NVIDIA RTX 40-series 기준)
